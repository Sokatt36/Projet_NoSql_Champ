...
public class Bdd {
    ...
    public String getRandomPoste(){
        Random rd = new Random();
        String[] lst = ReadFile.getPoste().toArray(new String[ReadFile.getPoste().size()]);
    ...
    public void creerPoste(String data){
        run("CREATE (n:Poste {nom: '"+data+"'})");
    }
